...
public class Ventana extends JPanel {
    ...
    public Ventana() {
        ...
        intA = new JTextField();
        intA.setBounds(new Rectangle(50, 115, widthTF, heightTF));

        intB = new JTextField();
        intB.setBounds(new Rectangle(200, 115, widthTF, heightTF));
        
        result = new JTextField();
        result.setBounds(new Rectangle(125, 250, widthTF, heightTF));

        sum = new JButton("+");
        sum.setBounds(new Rectangle(125, 60, widthTF, heightTF));
        
        res = new JButton(" - ");
        res.setBounds(new Rectangle(125, 90, widthTF, heightTF));
        
        mul = new JButton(" * ");
        mul.setBounds(new Rectangle(125, 120, widthTF, heightTF));
        
        div = new JButton(" / ");
        div.setBounds(new Rectangle(125, 150, widthTF, heightTF));
        ...
        sum.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Ventana.this.result.setText(sum.operar(a, b));
        ...
        res.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Ventana.this.result.setText(res.operar(a, b));
        ...
        mul.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Ventana.this.result.setText(mul.operar(a, b));
        ...
        div.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Ventana.this.result.setText(div.operar(a, b));
